...
import util  # Assuming util is needed for other parts of the code.
...
def depthFirstSearch(problem):
    ...
    while not frontier.isEmpty():
        ...
        if currentState not in explored:
            ...
            # Get successors and add them to frontier
        ...
        if currentState not in explored:
            ...
            for nextState, action, stepCost in problem.getSuccessors(currentState):
                if nextState not in explored:
                    ...
                    frontier.push((nextState, nextActions, nextCost), nextCost)
...
def aStarSearch(problem: SearchProblem, heuristic=nullHeuristic):
    ...
    # Initialize the frontier with start state, empty path, and zero cost
    frontier = util.PriorityQueue()
    startState = problem.getStartState()
        ...
        if currentState not in explored:
            ...
            for nextState, action, stepCost in problem.getSuccessors(currentState):
                if nextState not in explored:
                    ...
                    frontier.push((nextState, nextActions, nextCost), priority)
